...
public class Ventana_Proceso extends JFrame implements ActionListener{
    ...
    public Ventana_Proceso() {
        ...
        ar_res.setBackground(new Color(141, 232, 0));
        ar_res.setFont(new Font("Arial",0,16));
        ar_res.setForeground(new Color(255,255,255));
        ar_res.setText("Aqui aparece el resultado de la ecuacion :)");
        ...
        bt_regresar.setBackground(new Color(141,232,0));
        ...
        bt_salir.setBackground(new Color(141,232,0));
